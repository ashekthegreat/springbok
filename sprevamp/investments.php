...
<body>
    ...
    <main>
        ...
        <section class="investments-banner white sp-secondary-text">
            <div class="container">
                <div class="row">
                    <div class="col s12 m6 push-m6">
                        <div class="row">
                            <div class="col s12 l10 offset-l1 margin-bottom-20">
                                <form class="white z-depth-2">
                                    <div class="form-title sp-primary sp-secondary-text center-align">
                                        Get Exclusive Deals Now!
                                    </div>
                                    <div class="classic-form sp-secondary lighten-5 padding-30">
                                        ...
                                        <button type="submit" class="waves-effect waves-light btn-large btn-block big sp-primary sp-secondary-text">Register Now</button>
                                    </div>
                                </form>
                            </div>
                        </div>
        ...
        <section class="sp-secondary lighten-4 sp-secondary-text center-align">
            <div class="container">
                <div class="row">
                    <div class="col s12 m12">
