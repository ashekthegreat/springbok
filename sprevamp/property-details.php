...
<body>
    ...
    <main>
        ...
        <section class="property-details white sp-secondary-text">
            <div class="container">
                <div class="row">
                        ...
                        <div class="z-depth-1 sp-secondary lighten-5 margin-bottom-30">
                            ...
                            <div class="property-interest clearfix">
                                ...
                                <div class="text-center property-interest-details">
                                    ...
                                    <a class="waves-effect waves-light btn sp-primary sp-secondary-text margin-bottom-15 trigger-book-modal" href="#property-book" data-prop="145666">Book Viewing</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <aside class="main-sidebar hidden-print">
                            ...
                            <div class="card-panel margin-top-0 sp-secondary lighten-5 property-contact-methods">
                                <div class="item center-align">
                                    <a class="waves-effect waves-light btn sp-primary sp-secondary-text margin-bottom-15 trigger-book-modal" href="#property-book" data-prop="145666">Book Viewing</a>
                                    <a class="waves-effect waves-light btn sp-secondary sp-primary-text margin-bottom-15 trigger-book-modal" href="#property-book" data-prop="145666">Request Details</a>
                                ...
                                <div class="item property-sidebar-action">
                                    ...
                                    <div class="add-note-editor" style="display: none;">
                                        ...
                                        <div>
                                            ...
                                            <button class="btn btn-primary btn-save-note">Save Note</button>
