						...
						<div class="features animatedParent">
							<div class="margin-top-80 margin-bottom-0 row">
								<div class="col s12 m4 center-align">
                                    <img class="hero_speed animated fadeInDownShort" alt="" src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAJYAAACWAQMAAAAGz+OhAAAAA1BMVEX///+nxBvIAAAAAXRSTlMAQObYZgAAABpJREFUeNrtwTEBAAAAwqD1T20ND6AAAIB3Awu4AAFSPGZ8AAAAAElFTkSuQmCC">
									<h5>SPEED</h5>
									<p>You need cash in a few days or weeks? We have a solution</p>
								</div>
								<div class="col s12 m4 center-align value-box">
                                    <img class="hero_value animated fadeInDownShort" alt="" src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAH4AAAB+AQMAAADY7TfLAAAAA1BMVEX///+nxBvIAAAAAXRSTlMAQObYZgAAABlJREFUeNpjYBgFo2AUjIJRMApGwSigJgAACF4AAdHYkfQAAAAASUVORK5CYII=">
									<h5>MAXIMUM VALUE</h5>
									<p>You need to get 100% value? We have 1000s of case studies and success stories</p>
								</div>
								<div class="col s12 m4 center-align">
                                    <img class="hero_secure animated fadeInDownShort" alt="" src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAF4AAAB8AQMAAADaeJUQAAAAA1BMVEX///+nxBvIAAAAAXRSTlMAQObYZgAAABVJREFUeNpjYBgFo2AUjIJRMAooAwAGTAABqOTaNAAAAABJRU5ErkJggg==">
									<h5>SECURE SALE</h5>
