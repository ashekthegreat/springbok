                            ...
                            <div class="modal-exit-content">
                                ...
                                <div class="body-right">
                                    ...
                                    <ul class="free-checks">
                                        <li>
                                            <span class="material-icons green-text">check</span>
                                            A free desktop valuation for your property
                                        </li>
                                        <li>
                                            <span class="material-icons green-text">check</span>
                                            Clear &amp; unbiased advice on your options to sell fast
                                        </li>
                                        <li>
                                            <span class="material-icons green-text">check</span>
                                    ...
                                    <p class="bigger center-align text-bold">No hassle &amp; no obligation to sell.<br>You have nothing to lose.</p>
                    ...
                    <div class="exit-footer-buttons">
                        <div class="exit-footer-section footer-button-yes">
                            <button type="button" class="waves-effect waves-light btn-large btn-block green white-text footer-button" tabindex="-1">
                                <span class="first-step">Yes, <span class="button-sub">I want my free consultation</span></span>
                        ...
                        <div class="exit-footer-section footer-button-no">
                            <button type="button" class="waves-effect waves-light btn-large btn-block red white-text footer-button" tabindex="-1">
                                No, <span class="button-sub">I do not need expert property consultation for free</span>
                            </button>
                        </div>
                    </div>
