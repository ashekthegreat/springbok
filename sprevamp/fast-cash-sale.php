...
<main>
        ...
        <div class="container">
            <div class="row">
                <div class="col s12 m7 l6 animatedParent">
                    <p class="smaller breadcrumb-custom">Services --> Fast Cash Sale</p>
                    <h3 class="page-title animated fadeInDownShort">Fast Cash Sale</h3>
                    <h4 class="page-sub-title margin-bottom-20 animated fadeInDownShort">(Residential Properties)</h4>
                    <div class="main-speech-bg sp-secondary lighten-5"></div>
                    <div class="big main-speech animated fadeInRightShort">
                        A straight cash sale for your house, if you're looking to sell super fast or have a pressing
                        deadline to sell. You get cash in the bank fast and can exchange & move on a certain date.
                    </div>
    ...
    <section class="section-services-steps white sp-secondary-text">
        <div class="container services-container center-align animatedParent">
            <h3 class="text-bold">Fast Cash Sale - Simple 3 Step Process</h3>
    ...
    <section class="section-services-key-benefits sp-primary sp-secondary-text">
        <div class="container services-container animatedParent">
            ...
            <div class="key-benefits animated fadeInDownShort delay-250">
                <div class="key-benefit key-benefit-1">Cash in days</div>
                <div class="key-benefit key-benefit-2">Quick sale</div>
                ...
                <div class="col s12 m5 l6 padding-0">
                    <div class="shape-message animatedParent">
                        <div class="padding-15 sp-secondary white-text center-align margin-bottom-10 animated fadeInLeftShort">
                            8 other key benefits of our Fast Cash Sale >>
                        </div>
