<?php
	...
	$page_title = stripslashes($rc["meta_title"]);
	$page_description = stripslashes($rc["page_description"]);
	$page_keywords = stripslashes($rc["page_keywords"]);
	...
	{	
		?>
					...
					<div class="container">
						<div class="row margin-bottom-0 animatedParent">
							...
							<div class="col s12 m12 l9">
								<div class="logos">
									<img class="responsive-img logo-1 animated growIn delay-250" src="images/regulators/1.png" alt="The Property Ombudsman" width="169" height="49">
									<img class="responsive-img logo-2 animated growIn delay-500" src="images/regulators/2.png" alt="GOV.UK" width="153" height="62">
									<img class="responsive-img logo-3 animated growIn delay-750" src="images/regulators/3.png" alt="Approved Code" width="134" height="63">
									<img class="responsive-img logo-4 animated growIn delay-1000" src="images/regulators/4.png" alt="napb" width="119" height="67">
									<img class="responsive-img logo-5 animated growIn delay-1250" src="images/regulators/5.png" alt="nava" width="91" height="82">
								</div>
							</div>
						</div>
					</div>
						...
						<div class="features animatedParent">
							<div class="margin-top-80 margin-bottom-0 row">
								<div class="col s12 m4 center-align">
									...
									<h5>SPEED</h5>
									<p>You need cash in a few days or weeks? We have a solution</p>
								</div>
								<div class="col s12 m4 center-align value-box">
									...
									<h5>MAXIMUM VALUE</h5>
									<p>You need to get 100% value? We have 1000s of case studies and success stories</p>
								</div>
								<div class="col s12 m4 center-align">
									<img src="images/hero-frames/secure.png" width="94" height="124" alt="" class="animated fadeInDownShort">
									<h5>SECURE SALE</h5>
									<p>You need a secure sale for your peace of mind? We've got you covered</p>
								</div>
							</div>
						</div>
					</div>
		 ...
		 <section id="setuspart" class="springbook_propertiesapart scrollspy">
			<div class="container">
				  ...
				  <div class="row">
					<div class="col s12 m5 hide-on-med-and-up">
					  <div class="top_head hide-on-small-only"><img src="images/springbooklogo_icon.png" alt="logosmall"> Sell with springbok</div>
					  <div class="card">
					  ...
					  <div class="top_head"><img src="images/springbooklogo_icon.png" alt="logosmall"> Sell with springbok</div>
					  <div class="card">
						<div class="card-content left-align">
						  <ul>
					...
					<div class="col s12 m5 hide-on-small-only show-on-medium-and-up">
					  <div class="top_head grey lighten-2"><img src="images/highstreet_logo.png" alt="logosmall"> High-Street or Online Estate Agent Sale</div>
		  ...
		  <!--
		  <section id="data_driven" class="data-driven grey lighten-4 scrollspy">
			<div class="container">
			  <div class="row animatedParent">
				<div class="col s12 m12 l10 offset-l1">
				  <div class="container">
					<div class="col s12 m12 l10 offset-l1">
					  <h2 class="center">Data-driven valuations you can rely on</h2>
					  <p>We are incredibly accurate at valuing homes. Unlike other agents, we combine a data-backed approach with our pricing and marketing strategy to help achieve the highest price on optimal timelines.</p>
					  <ul id="tabs-swipe-demo" class="tabs">
						<li class="tab"><a href="#swipe-1">1 - Data Analysis</a></li>
						<li class="tab"><a href="#swipe-2">2 - Valuation</a></li>
						<li class="tab"><a href="#swipe-3">3 - Your Sale Options</a></li>
					  </ul>
					</div>
				  </div>
				  <div class="animated fadeInDownShort">
					<div id="swipe-1" class="carousel-item" href="#one!">
					  <div class="padding-left-20">
						<div class="col m6 s12 right order-md-2">
						  <p>Market-leading tools and trusted sources:</p>
						  <ul class="padding-left-30">
							<li>We collect data from HM Land Registry, Rightmove and multiple other portals</li>
							<li>We combine this with our property market and performance analytics</li>
							<li>We tap into local market intelligence </li>
						  </ul>
						</div>
						<div class="col s12 m6 center order-md-1"><img src="images/data-analysis.png" alt="data-analysis"></div>
					  </div>
					</div>
					<div id="swipe-2" class="carousel-item" href="#two!">
					  <div class="padding-left-20">
						<div class="col s12 m6 right order-md-2">
						  <p>Our experienced valuer generates an accurate valuation based on:</p>
						  <ul class="padding-left-30">
							<li>Data and price comparables</li>
							<li>Local market intelligence </li>
							<li>Your property's unique features and value additions</li>
						  </ul>
						</div>
						<div class="col s12 m6 center order-md-1"><img src="images/valuation.png" alt="data-analysis"></div>
					  </div>
					</div>
					<div id="swipe-3" class="carousel-item" href="#three!">
					  <div class="padding-left-20">
						<div class="col s12 m6 right order-md-2">
						  <p>We discuss your sale options:</p>
						  <ul class="padding-left-30">
							<li>Multiple fast sale options to choose from</li>
							<li>Tailored to your individual circumstances</li>
							<li>Plan B available for fast sale if route to market fails</li>


							<li>Cash advance option</li>
						  </ul>
						</div>
						<div class="col s12 m6 center order-md-1"><img src="images/your sale options.png" alt="data-analysis"></div>
					  </div>
					</div>
				  </div>
				</div>
				<div class="col s12 center-align margin-top-30"> <a href="/free-valuation"  class="waves-effect waves-light btn-large grey darken-4 center-align sp-primary-text">Book your Free valuation visit now</a> </div>
			  </div>
			</div>
		  </section>
		  -->
				...
				<div class="container animatedParent">
					...
					<div class="investment-videos" data-id="9mzmXW5t4ao">
						...
						<div class="row margin-bottom-0 animated fadeIn delay-250">
							...
							<div class="col s4 m2 l2">
								<div class="card" data-id="Ag5sJFE6vQM">
									<div class="card-image">
										<img class="responsive-img" src="https://img.youtube.com/vi/Ag5sJFE6vQM/mqdefault.jpg" width="320" height="180">
										<div class="play-button"><i class="social social-youtube-play-small"></i></div>
									</div>
						...
						<div class="play-button">
							<img src="images/services/youtube.png" width="512" height="384" class="youtube-play">
						</div>
					</div>
				</div>
			</section>
				...
				<div class="col s12">
				  ...
				  <div class="row center margin-top-30">
					...
					<div class="col s12 m4 l2">
					  ...
					  <p>You need to sell a £30,000 or £3,000,000 house, anywhere in the UK</p>
					</div>
					<div class="col s12 m4 l2">
					  <div class="icon">
			  ...
			  <div class="row">
				<div class="col s12 m10 offset-m1 offset-l1">
				  <div class="row">
					...
					<div class="col s12 m5"> <img src="images/ASA.png" alt="asa"> </div>
				  </div>
				  <div class="center">
					...
					<div class="col s12">
					  ...
					  <div class="row mb-0 animatedParent">
						<div class="col s12 m4">
						  <div class="card center animated fadeInLeft"><img src="images/Layer 114.png" alt=""></div>
						</div>
						<div class="col s12 m4">
						  <div class="card center animated fadeInLeft"><img src="images/Layer 118.png" alt=""></div>
						</div>
						<div class="col s12 m4">
						  <div class="card center animated fadeInLeft"><img src="images/Layer 122.png" alt=""></div>
						</div>
						<div class="col s12 m4">
						  <div class="card center animated fadeInLeft"><img src="images/Layer 38 copy 4.png" alt=""></div>
						</div>
						<div class="col s12 m4">
						  <div class="card center animated fadeInLeft"><img src="images/Layer 116.png" alt=""></div>
						</div>
						<div class="col s12 m4">
						  <div class="card center animated fadeInLeft"><img src="images/Layer 115.png" alt=""></div>
						</div>
						<div class="col s12 m4">
						  <div class="card center animated fadeInLeft"><img src="images/daily_express.png" alt=""></div>
						</div>
						<div class="col s12 m4">
						  <div class="card center animated fadeInLeft"><img src="images/london.png" alt=""></div>
						</div>
						<div class="col s12 m4">
						  <div class="card center animated fadeInLeft"><img src="images/estates.png" alt=""></div>
						</div>
						<div class="col s12 m4">
						  <div class="card center animated fadeInLeft"><img src="images/idealhome.png" alt=""></div>
						</div>
						<div class="col s12 m4">
						  <div class="card center animated fadeInLeft"><img src="images/residential.png" alt=""></div>
						</div>
						<div class="col s12 m4">
						  <div class="card center animated fadeInLeft"><img src="images/estate.png" alt=""></div>
						</div>
					  </div>
					</div>
				  </div>
			  ...
			  <div class="row margin-top-30">
				<div class="col s12 m6 l4 animatedParent">
				  <div class="blockcard animated fadeInUpShort">
					...
					<div class="card-image">
					  <h4>Bolton</h4>
					  <img src="images/BL2 6JA.jpg" alt=""></div>
					<div class="card-footer"><img width="25px" src="images/springbooklogo_icon.png" alt="">SALE AGREED IN 6 DAYS WITH SPRINGBOK</div>
				  </div>
				</div>
				<div class="col s12 m6 l4 animatedParent">
				  <div class="blockcard animated fadeInUpShort">
					...
					<div class="card-image">
					  ...
					  <img src="images/SW6 7ND.jpg" alt=""></div>
					<div class="card-footer"><img width="25px" src="images/springbooklogo_icon.png" alt="">SALE AGREED IN 19 DAYS WITH SPRINGBOK</div>
				  </div>
				</div>
				<div class="col s12 m6 l4 animatedParent">
				  <div class="blockcard animated fadeInUpShort">
					...
					<div class="card-image">
					  <h4>Stevenage</h4>
					  <img src="images/SG9 9EE.jpg" alt=""></div>
					<div class="card-footer"><img width="25px" src="images/springbooklogo_icon.png" alt="">SALE AGREED IN 17 DAYS WITH SPRINGBOK</div>
				  </div>
				</div>
			  </div>
			  <div class="row margin-top-30">
				<div class="col s12 m6 l4 animatedParent">
				  <div class="blockcard animated fadeInUpShort">
					...
					<div class="card-image">
					  <h4>Edinburgh</h4>
					  <img src="images/EH22 4AQ.jpg" alt=""></div>
					<div class="card-footer"><img width="25px" src="images/springbooklogo_icon.png" alt="">SALE AGREED IN 19 DAYS WITH SPRINGBOK</div>
				  </div>
				</div>
				<div class="col s12 m6 l4 animatedParent">
				  <div class="blockcard animated fadeInUpShort">
					...
					<div class="card-image">
					  <h4>Medway</h4>
					  <img src="images/ME12 4PR.jpg" alt=""></div>
					<div class="card-footer"><img width="25px" src="images/springbooklogo_icon.png" alt="">SALE AGREED IN 7 DAYS WITH SPRINGBOK</div>
				  </div>
				</div>
				<div class="col s12 m6 l4 animatedParent">
				  <div class="blockcard animated fadeInUpShort">
					...
					<div class="card-image">
					  <h4>Petersborough</h4>
					  <img src="images/PE14 9SH.jpg" alt=""></div>
					<div class="card-footer"><img width="25px" src="images/springbooklogo_icon.png" alt="">SALE AGREED IN 9 DAYS WITH SPRINGBOK</div>
				  </div>
				</div>
			  </div>
			  ...
			  <div class="row">
				<div class="col s12">
				  ...
				  <div class="col s6 m3 l2 animatedParent center">
					<div class="icon animated fadeInLeftShort go"><img src="images/best_possible.png" alt=""></div>
				  ...
				  <div class="col s6 m3 l2 animatedParent center">
					<div class="icon animated fadeInLeftShort go"><img src="images/tailior.png" alt=""></div>
				  ...
				  <div class="col s6 m3 l2 animatedParent center">
					<div class="icon animated fadeInLeftShort go"><img src="images/dedicated.png" alt=""></div>
				  ...
				  <div class="col s6 m3 l2 animatedParent center">
					<div class="icon animated fadeInLeftShort go"><img src="images/unique.png" alt=""></div>
				  ...
				  <div class="col s6 m3 l2 animatedParent center">
					<div class="icon animated fadeInLeftShort go"><img src="images/no_charges.png" alt=""></div>
				  ...
				  <div class="col s6 m3 l2 animatedParent center">
					<div class="icon animated fadeInLeftShort go"><img src="images/part_exchange.png" alt=""></div>
					<h5>Part exchange</h5>
				  ...
				  <div class="col s6 m3 l2 animatedParent center">
					<div class="icon animated fadeInLeftShort go"><img src="images/No Sale.png" alt=""></div>
				  ...
				  <div class="col s6 m3 l2 animatedParent center">
					<div class="icon animated fadeInLeftShort go"><img src="images/quicker.png" alt=""></div>
				  ...
				  <div class="col s6 m3 l2 animatedParent center">
					<div class="icon animated fadeInLeftShort go"><img src="images/24_7.png" alt=""></div>
				  ...
				  <div class="col s6 m3 l2 animatedParent center">
					<div class="icon animated fadeInLeftShort go"><img src="images/effective.png" alt=""></div>
				  ...
				  <div class="col s6 m3 l2 animatedParent center">
					<div class="icon animated fadeInLeftShort go"><img src="images/strict.png" alt=""></div>
				  ...
				  <div class="col s6 m3 l2 animatedParent center">
					<div class="icon animated fadeInLeftShort go"><img src="images/5star.png" alt=""></div>
				  ...
				  <div class="col s6 m3 l2 animatedParent center">
					<div class="icon animated fadeInLeftShort go"><img src="images/planb.png" alt=""></div>
					<h5>Plan B</h5>
				  ...
				  <div class="col s6 m3 l2 animatedParent center">
					<div class="icon animated fadeInLeftShort go"><img src="images/progessor.png" alt=""></div>
				  ...
				  <div class="col s6 m3 l2 animatedParent center">
					<div class="icon animated fadeInLeftShort go"><img src="images/national_adv.png" alt=""></div>
				  ...
				  <div class="col s6 m3 l2 animatedParent center">
					<div class="icon animated fadeInLeftShort go"><img src="images/manchester.png" alt=""></div>
				  ...
				  <div class="col s6 m3 l2 animatedParent center">
					<div class="icon animated fadeInLeftShort go"><img src="images/sp_hub.png" alt=""></div>
					<h5>Springbok Hub</h5>
					<p class="rowfour mobilenine">Get real-time updates on new offers and key notifications about your sale progress.</p>
				  </div>
				  <div class="col s6 m3 l2 animatedParent center">
					<div class="icon animated fadeInLeftShort go"><img src="images/more_money.png" alt=""></div>
					<h5>More money</h5>
				  ...
				  <div class="col s6 m3 l2 animatedParent center">
					<div class="icon animated fadeInLeftShort go"><img src="images/buyers_int.png" alt=""></div>
			...
			<div class="container">
			  ...
			  <div class="row">
				<div class="col s12 m4">
				  <div class="card hoverable" data-id="Ag5sJFE6vQM">
					<div class="card-image"> <img alt="youtube" class="responsive-img" src="https://img.youtube.com/vi/Ag5sJFE6vQM/mqdefault.jpg" width="320" height="180">
				...
				<div class="col s12 m4 hide-on-small-only">
				  <div class="card hoverable" data-id="F0WdUkXvBiQ">
					<div class="card-image"> <img alt="youtube" class="responsive-img" src="https://img.youtube.com/vi/F0WdUkXvBiQ/mqdefault.jpg" width="320" height="180">
					  <div class="play-button"><i class="social social-youtube-play-large"></i></div>
					</div>
				...
				<div class="col s12 m4 hide-on-small-only">
				  ...
				  <div class="card hoverable" data-id="BYKz90GY5EM">
					<div class="card-image"> <img alt="youtube" class="responsive-img" src="https://img.youtube.com/vi/BYKz90GY5EM/mqdefault.jpg" width="320" height="180">
					  <div class="play-button"><i class="social social-youtube-play-large"></i></div>
					</div>
			  ...
			  <ul class="small-videos ">
				<li class="card hoverable" data-id="0PK0_RMxgLs" >
				  <div class="card-image"> <img alt="youtube" class="responsive-img" src="https://img.youtube.com/vi/0PK0_RMxgLs/default.jpg" width="120" height="90">
					<div class="play-button"><i class="social social-youtube-play-small"></i></div>
				  </div>
				...
				<li class="card hoverable" data-id="P8TOSyLkWlo" >
				  <div class="card-image"> <img alt="youtube" class="responsive-img" src="https://img.youtube.com/vi/P8TOSyLkWlo/default.jpg" width="120" height="90">
				...
				<li class="card hoverable" data-id="mxbvoMspw0k" >
				  <div class="card-image"> <img alt="youtube" class="responsive-img" src="https://img.youtube.com/vi/mxbvoMspw0k/default.jpg" width="120" height="90">
					<div class="play-button"><i class="social social-youtube-play-small"></i></div>
				  </div>
				...
				<li class="card hoverable" data-id="mvsbbI3tXA4" >
				  <div class="card-image"> <img alt="youtube" class="responsive-img" src="https://img.youtube.com/vi/mvsbbI3tXA4/default.jpg" width="120" height="90">
					<div class="play-button"><i class="social social-youtube-play-small"></i></div>
				  </div>
				...
				<li class="card hoverable" data-id="QedLPJ3dYXU" >
				  <div class="card-image"> <img alt="youtube" class="responsive-img" src="https://img.youtube.com/vi/QedLPJ3dYXU/default.jpg" width="120" height="90">
					<div class="play-button"><i class="social social-youtube-play-small"></i></div>
				  </div>
				...
				<li class="card hoverable" data-id="PPJv9AY77KU" >
				  <div class="card-image"> <img alt="youtube" class="responsive-img" src="https://img.youtube.com/vi/PPJv9AY77KU/default.jpg" width="120" height="90">
					<div class="play-button"><i class="social social-youtube-play-small"></i></div>
				  </div>
				...
				<li class="card hoverable" data-id="EfgAXRE6Ybk" >
				  <div class="card-image"> <img alt="youtube" class="responsive-img" src="https://img.youtube.com/vi/EfgAXRE6Ybk/default.jpg" width="120" height="90">
					<div class="play-button"><i class="social social-youtube-play-small"></i></div>
				  </div>
				...
				<li class="card hoverable" data-id="iY38J2sNq-U" >
				  <div class="card-image"> <img alt="youtube" class="responsive-img" src="https://img.youtube.com/vi/iY38J2sNq-U/default.jpg" width="120" height="90">
					<div class="play-button"><i class="social social-youtube-play-small"></i></div>
				  </div>
				...
				<li class="card hoverable" data-id="AL18YfGfBQ8" >
				  <div class="card-image"> <img alt="youtube" class="responsive-img" src="https://img.youtube.com/vi/AL18YfGfBQ8/default.jpg" width="120" height="90">
					<div class="play-button"><i class="social social-youtube-play-small"></i></div>
				  </div>
				...
				<li class="card hoverable" data-id="0Irq3ggPT4Y" >
				  <div class="card-image"> <img alt="youtube" class="responsive-img" src="https://img.youtube.com/vi/0Irq3ggPT4Y/default.jpg" width="120" height="90">
					<div class="play-button"><i class="social social-youtube-play-small"></i></div>
				  </div>
			  ...
			  <div class="masonry clearfix center-align">
				...
				<div class="row masonry_row">
				  <div class="card-panel white margin-0 sp-primary sp-secondary-text valign-wrapper custom-height-1">
					<div class="valign">
					  <div class="">
						<div class="big less spantag counter">£3,500,000</div>
					  </div>
		  ...
		  <section id="houseworth" class="houseprices scrollspy">
			<div class="container relative zindex">
			  ...
			  <div class="row center-align">
				<div class="col s12 animatedParent"> <img class="animated fadeInUpShort" src="images/graph.png" alt=""> </div>
				<div class="col l8 offset-l2 m8 s12 offset-m2">
				  ...
				  <div class="right mt-1"><img src="images/poweredby.png" alt="poweredby"></div>
				</div>
				<div class="col l6 offset-l3 m8 s12 offset-m2">
				  <div class="input-field input-group dflex margin-top-50">
					<form name="frmSeller2" action="//simbacloud.co.uk/Users/forms/processForm.php"  class="wf_f2" method="post">
						...
						<span class="get-free-report-btn"> <button type="submit" id="" class="btn-large waves-effect waves-light grey darken-4 sp-primary-text">Get Your Free Report Now</button> <span class="d-block center">Can’t find your address? <u><a href="javascript:void(0)" id="send-to-slider">Enter it here</a></u></span> </span> 
		  ...
		  <section class="chat_section scrollspy">
			<div class="container-fluid">
			  <div class="row dflex alignitem">
				<div class="col s12 m6 l6"><img src="images/chatsection_people.jpg" width="758" height="545" alt=""></div>
				<div class="col s12 m5 l4">
				  ...
				  <form class="wf_1" action="//simbacloud.co.uk/Users/forms/processFormValid.php" method="post">
					<input placeholder="Your Name" id="name" name="name" type="text" class="chat-form">
