...
$(function () {
    ...
    function resizeImages() {
        ...
        if (ww >= 768) {
            var h = $(".offer-form").outerHeight() - $(".site-header").outerHeight(true);
            $("#site-carousel img").height(h);
        } else {
            $("#site-carousel img").css("height", "");
        }
        $(".card-testimonials").height($(".card:first").height());
    }
    resizeImages();
