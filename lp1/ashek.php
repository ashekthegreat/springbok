...
<body>
            ...
            <section class="main">
                ...
                <div class="box">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-sm-8">
                                <h1 class="site-header">Sell House Fast - Guaranteed Offer in 24 Hours</h1>
                            ...
                            <div class="col-sm-4">
                                <div class="offer-form">
                                    <form onsubmit="return ValidateWebForm2();" action="http://simbacloud.co.uk/Users/forms/processForm.php" method="POST" name="web_form2">
                                        ...
                                        <input type="hidden" value="yellowspringbok.co.uk" name="_source">
                                        <input type="hidden" value="" name="_page_url">
    ...
    <div class="sprite sprite-floating_PPC hidden-xs"></div>
