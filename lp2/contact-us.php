            ...
            <section class="main">
                <div class="box">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-sm-8">
                                <h1 class="site-header">Contact Us</h1>

                                <img src="images/assets/img/lp2-nat-net.png" class="img-responsive" alt="">
                            </div>
                            <div class="col-sm-4">
                ...
                <div class="box">
                    <div class="container-fluid">
                        <p class="lead">
                            Need to ask a question? Want more information? Ready to sell your property?
                        </p>
                        <p>
                            Call us on Freephone 0800 068 7935 or fill in form for a callback.
                        </p>
                        <p>&nbsp;</p>
                        <div class="row">
                            <div class="col-sm-4">
                                <h4>Yellow Springbok Head Office</h4>
                                <p>&nbsp;</p>
                                <address>
                                    <strong>1, Universal Square</strong><br>
                            ...
                            <div class="col-sm-8">
                                <h4>Google Map</h4>
                                <div class="">
                                    <iframe width="100%" height="350" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://maps.google.co.in/maps?f=q&source=s_q&hl=en&geocode=&q=Yellow+Springbok,+Universal+Square+Devonshire+Street+North+Manchester+M12+6JH&aq=&sll=53.47073,-2.21426&sspn=0.014203,0.040169&ie=UTF8&hq=Yellow+Springbok,+Universal+Square&hnear=Devonshire+St+N,+Manchester+M12+6JR,+United+Kingdom&ll=53.47073,-2.214272&spn=0.006295,0.006295&t=m&output=embed&iwloc=near&z=14"></iframe>
                                </div>
                            </div>
                        </div>
                        <p>&nbsp;</p>
