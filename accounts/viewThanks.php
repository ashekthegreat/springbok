        ...
        <section class="sp-secondary-text section-view-thanks">
            <div class="container narrow">
                ...
                <form name="frmBuyerQual" id="frmBuyerQual" action="" method="post">
                    <div class="form-step card-panel spaced">
                        ...
                        <div class="center-align margin-top-40">
                            <button class="waves-effect waves-light btn btn-block-on-small sp-primary sp-secondary-text" type="button" id="thanks-step-1">Continue</button>
                        </div>
                    </div>

                    <div class="form-step hide card-panel spaced">
                        ...
                        <div class="form-step-content">
                            ...
                            <div class="other-text">
                                <textarea id="txtOther" name="txtOther" rows="3" style="display: none; height: 75px;" class="margin-0"></textarea>
                            </div>
                        </div>

                        <div class="center-align margin-top-40">
                            <button class="waves-effect waves-light btn btn-block-on-small sp-primary sp-secondary-text" type="button" id="thanks-step-2">Continue</button>
                        </div>
                    </div>
                    ...
                    <div class="form-step hide card-panel spaced">
                        ...
                        <div class="center-align margin-top-40">
                            <button class="waves-effect waves-light btn btn-block-on-small sp-primary sp-secondary-text" type="button" id="thanks-step-3">Continue</button>
                        </div>
                    </div>
                    ...
                    <div class="form-step hide card-panel spaced">
                        ...
                        <div class="center-align margin-top-40">
                            <button class="waves-effect waves-light btn btn-block-on-small sp-primary sp-secondary-text" type="button" id="thanks-step-4">Continue</button>
                        </div>
                    </div>
